...
public class DBUtil {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/spring_boot_demo?serverTimezone=PRC&useInformationSchema=true";
    ...
    private void init() {
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/spring_boot_demo?serverTimezone=PRC&useInformationSchema=true", "root", "root");
            if (connection != null) {
