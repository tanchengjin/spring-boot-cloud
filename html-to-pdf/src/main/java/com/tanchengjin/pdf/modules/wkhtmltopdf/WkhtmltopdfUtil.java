...
public class WkhtmltopdfUtil {
     ...
     *
     * @param exec       可执行文件
     * @param cacheDir 存储文件夹
     */
    public WkhtmltopdfUtil config(String exec, String cacheDir) {
        this.exec = exec;
    ...
    public String toPDF() {
        ...
        String fileName = cacheDir + File.separator + fileStoragePath + File.separator + uuid;
...
//            cmd.append(" --grayscale");
        ...
        //边距
//        cmd.append(" --margin-left 0mm --margin-right 0mm --margin-top 0mm --margin-bottom 0mm");
