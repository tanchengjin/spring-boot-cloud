...
public class DictSerializer implements ObjectSerializer {
    private final DictOperator dictOperator;
    private final static Logger logger = LoggerFactory.getLogger(DictSerializer.class);
    private static final String FIELD_KEY_EXT = "Text";
    ...
    public DictSerializer(DictOperator dictOperator) {
            ...
            for (String name : fieldNames) {
                ...
                if (field != null) {
                    ...
                    if (annotation != null) {
                        ...
                        String articleCategory = dictOperator.getDictString("article_category", fieldValue.toString(), "name");
                        Object msg = method.invoke(null, Objects.toString(articleCategory));
